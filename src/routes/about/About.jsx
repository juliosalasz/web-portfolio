    ...
    <div className="w-full py-20 px-5 bg-[#F9F9F9]">
      <div className="mx-auto grid md:grid-cols-2 ">
        <div className="mx-auto relative">
          ...
          <div className="w-[343px] ms:w-[420px] sm:w-[445px] md:w-[430px] lg:w-[400px] xl:w-[495px] h-[5px] bg-black absolute top-[13px] ms:top-[14px] xl:top-[18px] left-[-106px] xl:left-[-200px]"></div>
          <img
        ...
        <div className="mt-0 mx-auto md:mt-[180px] lg:mt-[100px]">
          <div className="relative">
            ...
            <div className="w-[270px] ms:w-[297px] sm:w-[375px] md:w-[311px] lg:w-[508px] xl:w-[715px] h-[5px] bg-black absolute bottom-[15px] sm:bottom-[17px] md:bottom-[14px] lg:bottom-[28px] xl:bottom-[18px] right-[-20px] xl:right-[-20px] "></div>
          </div>
